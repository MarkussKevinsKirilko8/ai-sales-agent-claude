...
SOURCE_STRINGS = {
    ...
    "opt_in_message": (
        "В этом магазине теперь работает AI-ассистент. "
        "Нажмите кнопку ниже, чтобы общаться с ним. "
        "Если хотите остаться с менеджером, ничего не нажимайте."
    ),
    "opt_in_button": "🤖 Переключиться на AI",
    "opt_in_confirmed": "Вы переключены на AI-ассистента. Можете задать любой вопрос.",
}

TRANSLATIONS_VERSION = 5
